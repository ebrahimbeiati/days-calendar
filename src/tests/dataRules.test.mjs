...
describe('dayRules tests', () => {
  test('ADA 2024', () => {
    // year 2024, month October (9), weekday Tuesday (2), 2nd occurrence
    //What is the second Tuesday of October 2024?
  ...
  // year 2024, month October (9), weekday Friday (5), last occurrence
//What is the last Friday of October 2024?
  test('Lemur 2024', () => {
